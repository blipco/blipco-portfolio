    ...
    return (
      <div id="movieFinder">
        ...
        <div id="movieFinderDescription" className="allProjectDescription">
          ...
          <p>
            The Movie Finder was created with Javascript, React and React Router. <br/>
            In order to render the movie information I used the OMDB API.
                the OMDB API. I designed it with custom CSS styling.
          </p>
